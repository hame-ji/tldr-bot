...
Review-Note: Added CI subprocess coverage for module-style script entrypoints.
...
- Each module has a dedicated test file. New logic needs regression coverage in the matching file; CI entrypoints now have a dedicated subprocess test module.
