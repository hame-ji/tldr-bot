...
Review-Note: Added negative-path subprocess coverage for missing and malformed pipeline logs in extract_processed_urls helper.
...
- Each module has a dedicated test file. New logic needs regression coverage in the matching file; CI entrypoints include subprocess tests for module invocation, helper extraction, empty-day commit policy, and helper failure diagnostics.
