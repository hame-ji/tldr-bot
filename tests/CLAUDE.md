...
Review-Note: Added coverage for empty-day run_outcome mapping to skipped commit status.
...
- Each module has a dedicated test file. New logic needs regression coverage in the matching file; CI entrypoints include subprocess tests for module invocation and empty-day commit policy.
